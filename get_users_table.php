...
if ($user_result->num_rows > 0) {
    while ($row = $user_result->fetch_assoc()) {
        ...
        echo "<td>" . "<a href= '#' id='change_user_type_button' class='badge badge-sm color-primary' user_id='" . $row["user_id"] . "' user_type='" . $row["user_type"] . "' first_name='" . $row["first_name"] . "' last_name='" . $row["last_name"] . "' data-bs-toggle='modal' data-bs-target='#changeUserTypeModal'>Change User Type</a></br>
